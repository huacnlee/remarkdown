...
private def assert_render(input, output, file = __FILE__, line = __LINE__)
  it "renders #{input.inspect}", file, line do
    Remarkdown.to_html(input).should eq(output), file, line
  end
end

describe Remarkdown do
  describe "empty" do
    assert_render "", ""
  end
  ...
  describe "Paragraph" do
    ...
    describe "strikethrough" do
      assert_render "~~Hello~~ world", "<p><del>Hello</del> world</p>"
      assert_render "~~**Hello**~~ world", "<p><del><strong>Hello</strong></del> world</p>"
      assert_render "*~~**Hello**~~* world", "<p><em><del><strong>Hello</strong></del></em> world</p>"
      assert_render "*~~**`Hello`**~~* world", "<p><em><del><strong><code>Hello</code></strong></del></em> world</p>"
    end
  end
